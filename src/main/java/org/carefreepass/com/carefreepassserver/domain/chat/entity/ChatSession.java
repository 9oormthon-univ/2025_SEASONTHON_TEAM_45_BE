...
/**
 * 채팅 세션 엔티티
 * 환자와 AI 간의 증상 상담 채팅 세션을 관리합니다.
 * 각 세션은 여러 메시지와 하나의 증상 분석 결과를 포함할 수 있습니다.
 */
@Entity
@Getter
...
public class ChatSession extends BaseTimeEntity {
    ...
    /**
     * 새로운 채팅 세션 생성 정적 팩토리 메서드
     * 초기 상태는 ACTIVE로 설정됩니다.
     * 
     * @param member 채팅 세션을 시작하는 환자
     * @param title 채팅 세션 제목
     * @return 생성된 채팅 세션
     */
