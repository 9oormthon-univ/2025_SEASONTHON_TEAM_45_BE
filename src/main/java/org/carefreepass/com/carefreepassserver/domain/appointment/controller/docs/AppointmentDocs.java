...
@Tag(name = "예약 관리 API", description = "환자 예약 생성, 수정, 조회, 삭제 기능")
public interface AppointmentDocs {
    ...
    @Operation(
            summary = "예약 상태 변경",
            description = "예약의 상태를 변경합니다. (BOOKED→ARRIVED→CALLED→COMPLETED 또는 CANCELLED)",
            responses = {
    ...
    @Operation(
            summary = "예약 정보 수정",
            description = "예약의 병원명, 진료과, 의사명, 날짜, 시간 등을 수정합니다. 완료/취소된 예약은 수정할 수 없습니다.",
            responses = {
